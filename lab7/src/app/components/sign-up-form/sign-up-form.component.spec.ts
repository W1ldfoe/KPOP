...
describe('SignUpFormComponent', () => {
  ...
  it('form is invalid', () => {
    ...
    component.formModel.fullName = 'Dykyi max';
    fixture.detectChanges();
  ...
  it('login is empty', () => {
    const nativeElement = fixture.nativeElement;
    expect(nativeElement.querySelector('#login-error').textContent).toBe('Это поле не может быть пустым');
    component.formModel.login = '##!43';
    fixture.detectChanges();
    expect(nativeElement.querySelector('#login-error').textContent).toBe('Используйте английськие буквы');
    component.formModel.login = 'somelogin';
    fixture.detectChanges();
  ...
  it('email is empty or invalid', () => {
    const nativeElement = fixture.nativeElement;
    expect(nativeElement.querySelector('#email-error').textContent).toBe('Это поле не может быть пустым');
    component.formModel.email = 'someemail';
    fixture.detectChanges();
    expect(nativeElement.querySelector('#email-error').textContent).toBe('Неверный email');
  ...
  //   component.formModel.ISQNumber = '45456567'; 
  //   fixture.detectChanges();
  //   expect(nativeElement.querySelector('#icq-error')).toBeFalsy();
  // });
